...
```{r}
sqldf("SELECT * FROM amazon_df LIMIT 50")
```
In this simple query, we simply SELECTed all attributes FROM our dataset amazon_df. We then Limited it to only 50 elements, since displaying over 3000 would be way too many. The star (*) means "all" in SQL. This did not really do much, since all it did was give us back amazon_df. However, we can make it do more interesting things. Let's try something more interesting. 
